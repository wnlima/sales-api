...
{
    public class ManagerSalesControllerTests : IAsyncLifetime, IClassFixture<HttpClientFixture>
    {
        ...
        public ManagerSalesControllerTests(HttpClientFixture clientFixture)
        {
        ...
        public async Task ListSales_Expect_200_OK_And_Pagination()
        {
            ...
            var response = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales", _valiManagerToken);
            var response2 = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales?_page=2&_size=5", _valiManagerToken);
        ...
        public async Task ListSales_Expect_200_OK_And_Desc_Ordered_Results()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales?_order=totalamount desc", _valiManagerToken);
        ...
        public async Task ListSales_Expect_200_OK_And_Asc_Ordered_Results()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales?_order=totalamount asc", _valiManagerToken);
            var apiResponse = await DeserializePaginatedResponse<SaleResponse>(response);
        ...
        public async Task ListSales_Expect_200_OK_And_Filtered_Results()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, $"/api/manager/sales?branchid={BranchValue}", _valiManagerToken);
        ...
        public async Task ListSales_Expect_200_OK_And_Filtered_Results_Partial_Match()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, $"/api/manager/sales?branchid={partialBranchId}*", _valiManagerToken);
        ...
        public async Task ListSales_Expect_200_OK_And_Results_Filtered_By_TotalAmount_Range()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, $"/api/manager/sales?_minTotalAmount={minTotalAmount}&_maxTotalAmount={maxTotalAmount}", _valiManagerToken);
        ...
        {
            // Act
            var response1 = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales?_page=0", _valiManagerToken);
            var response2 = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales?_size=0", _valiManagerToken);
        ...
        public async Task ListSales_Expect_200_OK_And_Empty_List_When_No_Results_Match_Filter()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, $"/api/manager/sales?branchid={nonExistentBranchId}", _valiManagerToken);
        ...
        public async Task ListSales_Expect_200_OK_And_Results_Ordered_By_Multiple_Fields()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales?_order=totalamount desc,saledate asc", _valiManagerToken);
            var apiResponse = await DeserializePaginatedResponse<SaleResponse>(response);
        ...
        {
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, "/api/manager/sales?_order=price desc", _valiManagerToken);
            var apiResponse = await DeserializePaginatedResponse<SaleResponse>(response);
        ...
        public async Task GetSaleById_Expect_200_OK_On_Successful_Sale_Retrieval()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, $"/api/manager/sales/{sale.Id}", _valiManagerToken);
        ...
        public async Task GetSaleById_Expect_404_Not_Found_When_Sale_ID_Does_Not_Exist()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Get, $"/api/manager/sales/{nonExistentId}", _valiManagerToken);
        ...
        public async Task CancelSale_Expect_204_NoContent_On_Successful_Sale_Deletion()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Delete, $"/api/manager/sales/{createdSale.Data.Id}", _valiManagerToken);
        ...
        public async Task CancelSale_Expect_404_Not_Found_When_Sale_ID_Does_Not_Exist()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Delete, $"/api/manager/sales/{nonExistentId}", _valiManagerToken);
        ...
        public async Task CancelSale_Expect_401_Invalid_Role()
        {
            ...
            // Act
            var response = await _clientFixture.RequestSend(HttpMethod.Delete, $"/api/manager/sales/{nonExistentId}", _invaliManagerToken);
