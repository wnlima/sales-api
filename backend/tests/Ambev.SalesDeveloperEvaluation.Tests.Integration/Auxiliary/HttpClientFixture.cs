...
using Ambev.SalesDeveloperEvaluation.Tests.Integration.Auxiliary;
using Ambev.SalesDeveloperEvaluation.WebApi;
...
namespace Ambev.SalesDeveloperEvaluation.Integration.Auxiliary
{
