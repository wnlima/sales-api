...
using Ambev.UsersDeveloperEvaluation.WebApi;
...
namespace Ambev.UsersDeveloperEvaluation.Tests.Integration.Auxiliary
{
    public sealed class HttpClientFixture : IDisposable
    {
        ...
        public async Task<HttpResponseMessage> RequestSend(HttpMethod httpMethod, string requestUri)
        {
            var request = new HttpRequestMessage(httpMethod, requestUri);
            return await Client.SendAsync(request);
        }

        public async Task<HttpResponseMessage> RequestSend<TValue>(HttpMethod httpMethod, string requestUri, TValue value = null) where TValue : class
        {
            var request = new HttpRequestMessage(httpMethod, requestUri);
