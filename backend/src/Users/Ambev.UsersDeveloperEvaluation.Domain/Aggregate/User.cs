...
using Ambev.UsersDeveloperEvaluation.Domain.Common;
using Ambev.UsersDeveloperEvaluation.Domain.Enums;
using Ambev.UsersDeveloperEvaluation.Domain.Validation;

namespace Ambev.UsersDeveloperEvaluation.Domain.Entities
{
    ...
    public class User : BaseEntity, IUser, IAggregateRoot
    {
        ...
        /// <summary>
        /// Performs validation of the user  using the UserValidator rules.
        /// </summary>
        /// <returns>
